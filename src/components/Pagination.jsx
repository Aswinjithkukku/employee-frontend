    ...
    return (
        <div className="flex flex-wrap gap-[10px] items-center justify-between">
            ...
            <div className="flex items-center gap-[5px]">
                <button
                    className="px-[10px] h-[32px] font-[500] text-[13px] disabled:cursor-not-allowed bg-white border text-gray-500 hover:text-white hover:bg-blue-800 disabled:hover:bg-[#fff] disabled:hover:text-gray-600"
                        ...
                        return (
                            <button
                                className={
                                    ...
                                    (skip === index
                                        ? "font-medium  bg-blue-800 text-white"
                                        : "bg-transparent text-gray-500 font-normal border hover:bg-[#f3f6f9] ")
                                }
                                key={index}
